...
const ToolThemeContext = createContext<ToolTheme | null>(null);

export const useToolTheme = (): ToolTheme | null => {
...
export function ToolPageLayout({
  ...
  return (
    <ToolThemeContext.Provider value={{ iconColor }}>
      <div className="min-h-screen bg-background flex flex-col">
        <Navbar />
        <main className="flex-1">
          {/* Header */}
          <section className="border-b border-border bg-muted/30 py-10 sm:py-12 lg:py-9">
